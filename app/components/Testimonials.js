...
const Testimonials = () => {
  const testimonials = [
    { name: 'Archna Devi', review: 'I am experiencing great results with Dr. Suhas treatment for my IBS. His methods are working well for my symptoms, and I feel much better now.' },
    ...
    { name: 'Navdeep', review: 'Dr. Suhas professional expertise and personalised care at Yukti Herbs Hospital have greatly improved my health; he is an exemplary doctor.' },
    { name: 'Ravi Suri', review: 'After suffering from IBS for 12 years, I saw Dr. Suhas video on Instagram,  and came to Yukti Herbs Hospital for treatment—now I am fully recovered.' },

    { name: 'Sukhwinder Singh', review: 'Dr. Suhas way of educating me about IBS and the precautions to take has been amazing, and thanks to his treatment at Yukti Herbs Hospital, I am now fully recovered.' },
    { name: 'Vaibhav Gaur', review: 'I am taking Dr. Suhas treatment, medicines as well as Panchakarma and it is very effective for my IBS symptoms' },
